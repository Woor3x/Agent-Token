...
<div class="grid grid-cols-3 gap-6 mt-6 max-w-2xl text-sm">
  <div>
    <div class="dim text-xs" style="font-family: 'JetBrains Mono', monospace;">LEADER</div>
    <div style="font-family: 'Fraunces', serif; font-size: 1.1rem;">陈奕燔</div>
    <div class="mute text-xs">IdP · OPA · Audit</div>
  </div>
  <div>
    ...
    <div class="mute text-xs">Gateway · Web</div>
  </div>
  <div>
    <div class="dim text-xs" style="font-family: 'JetBrains Mono', monospace;">ENGINEER</div>
...
<div>
  ...
  <div class="toc-row">
    ...
    <div class="toc-title">模块细分 — IdP · OPA · Audit · GW · Agents · SDK</div>
  </div>
  <div class="toc-row">
...
<div class="card">
  ...
  <div class="card-body mt-1">
    业界通用策略引擎 · 直接复用不重造 · 策略文件版本化 · 单元测试与代码解耦。
  </div>
</div>
...
<div class="page-num">09 / 15</div>
<div class="page-anchor">§ 05 · MODULE III</div>

<div class="eyebrow">05.3 · 模块③ · 可观测与撤销</div>
<h1>Audit — <span class="accent">6 维撤销</span> · 全链审计</h1>
<div class="hr-soft"></div>
...
```
  ...
  <div class="card-body mt-2 text-xs">事件驱动 invalidation · 集群多副本秒级生效 · OPA 命中即拒。</div>
</div>
...
<div class="card">
  ...
  <div class="card-body mt-3 text-xs">
    每次 OPA 决策 + Gateway 转发都落审计 · 拒绝带 reasons → 可解释、可追溯。
  </div>
</div>
...
<div class="page-num">10 / 15</div>
<div class="page-anchor">§ 05 · MODULE IV</div>

<div class="eyebrow">05.4 · 模块④ · 唯一入口</div>
...
<div class="page-num">11 / 15</div>
<div class="page-anchor">§ 05 · MODULE V</div>

<div class="eyebrow">05.5 · 模块⑤ · Agent 编排与执行</div>
...
<div class="page-num">12 / 15</div>
<div class="page-anchor">§ 05 · MODULE VI</div>

<div class="eyebrow">05.6 · 模块⑥ · SDK 生态适配</div>
<h1>SDK — <span class="accent">3 框架适配</span> · 77 测试全过</h1>
<div class="hr-soft"></div>
...
<div class="card">
  ...
  <div class="card-body mt-2">
    ...
    • LangChain · <code>StructuredTool.from_function</code> + ctx_provider 隔离敏感字段<br/>
    • LangGraph · <code>make_a2a_node()</code> · 节点级 invoke · 零依赖<br/>
    • AutoGen · <code>A2AAgent(ConversableAgent)</code> · 工具注入<br/>
    <span class="dim">屏蔽 RFC 8693 TE + RFC 9449 DPoP + W3C traceparent</span>
  </div>
</div>
...
<div class="card">
  ...
  <div class="card-body mt-2">
    ...
    <span class="mute"> SDK 单元 + 集成测试 · 100% pass</span><br/>
    覆盖 TE / DPoP / capability / adapter / fault injection
  </div>
  <div class="card-body mt-3 text-xs">
    任何框架可接入 — 接 SDK 即享零信任授权 · 业务零 RFC 成本。
  </div>
</div>
...
<div class="grid grid-cols-3 gap-4 mt-3 text-xs">
  <div>
    <span class="pill pill-accent">STANDARD</span>
    <div class="mute mt-1">基于 IETF 标准协议栈 — 不绑死任何 SaaS</div>
  </div>
  <div>
    <span class="pill pill-accent">PLUGGABLE</span>
    <div class="mute mt-1">任意框架 4 行代码接入 — Tool / Node / Agent 三模式</div>
  </div>
  <div>
    <span class="pill pill-accent">VERIFIED</span>
    <div class="mute mt-1">77 测试覆盖 TE / DPoP / capability / fault</div>
  </div>
</div>

<!--
P12 SDK 30s
- 双卡：SDK adapter + 77 测试
- 三 pill：标准 / 可插拔 / 已验证
- 强调"接 SDK 即享" — 业务零 RFC 成本
-->
...
<div class="grid grid-cols-3 gap-6 mt-6 max-w-3xl text-sm">
  <div>
    ...
    <div class="mute text-xs">IdP · OPA · AuditApi</div>
  </div>
  <div>
    <div class="dim text-xs" style="font-family: 'JetBrains Mono', monospace;">ENGINEER</div>
